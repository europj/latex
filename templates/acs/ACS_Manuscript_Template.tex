...
%------------------------------------------------------------------------------------------------------------------------
% The documentclass options and setkeys command enable the printing of the entire
% author list for citations; this is especially useful for printing the entire Gaussian author list.
%
% For a list of journal types for the journal option below, see the table at the end of this
% document.
%------------------------------------------------------------------------------------------------------------------------
